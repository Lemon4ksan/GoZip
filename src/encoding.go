...
// 2. If valid UTF-8, return as is (heuristic for tools that forget the flag).
// 3. Fallback: decode as CP437 (IBM PC).
func decodeText(data string, flags uint16) string {
	if flags&0x800 != 0 {
		return data
	}
